...
namespace FarmCommerce.Services
{
    ...
    {
        public KorisnikService(FarmCommerceContext context, IMapper mapper) : base(context,mapper)
        {
        }
        ...
        {
            var entity = _context.Korisniks.Include("KorisniciUloges.Uloga").FirstOrDefault(x => x.KorisnickoIme == username);
            if (entity == null)
            {
                return null;
            }
