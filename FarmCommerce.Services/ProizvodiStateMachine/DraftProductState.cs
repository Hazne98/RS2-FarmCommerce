...
namespace FarmCommerce.Services.ProizvodiStateMachine
{
    public class DraftProductState : BaseState
    {
        ...
        public DraftProductState(ILogger<DraftProductState> logger, IServiceProvider serviceProvider, Database.FarmCommerceContext context, IMapper mapper) : base(serviceProvider, context, mapper)
        {
            _logger = logger;
        }
